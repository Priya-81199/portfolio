                ...
                <div  style={{display:(height<width)?'flex':'block'}}>
                    <div>
                        ...
                        <div class="fadeup-enter-done" style={{transitionDelay: '500ms'}}>
                            <a href="mailto:rajs80266@gmail.com" class="email-link btn" >
                                Get In Touch
                            </a>
                        </div>
                ...
                <div className='footer-div'>
                    {
                        ...
                        <>
                            <ul className="footer-links">
                                <a href="https://github.com/rajs80266"><li><GitHubIcon/></li></a>
                                <a href="https://www.instagram.com/rajs80266/"><li><InstagramIcon/></li></a>
